...
export declare class Gif implements Loadable<ImageSource[]> {
     ...
     * @deprecated
     */
    toLegacySprite(id?: number): LegacyDrawing.Sprite;
    /**
     * Return the gif as a legacy spritesheet
     * @deprecated
     * @returns
     */
    toLegacySpriteSheet(): LegacyDrawing.SpriteSheet;
    /**
     * Return the gif as a legacy animation
     * @deprecated
     * @param speed
     */
    toLegacyAnimation(engine: Engine, speed: number): LegacyDrawing.Animation;
    /**
